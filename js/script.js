...
// Плавная прокрутка по якорям с учётом высоты header
...
// Галерея сертификатов: клик по миниатюре
...
window.addEventListener('resize', () => moveSlide(0)); // обновить позицию при ресайзе
